...
public class BatchAdapter extends CursorAdapter {
  ...
  public BatchAdapter(Context context, Cursor c) {
    ...
    mIdIndex = c
        .getColumnIndexOrThrow(BatchNumbersContentProvider.COLUMN_ID);
    mNumberIndex = c
        .getColumnIndexOrThrow(BatchNumbersContentProvider.COLUMN_TEXT);
  }
